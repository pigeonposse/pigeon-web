<script lang="ts">
    ...
    import { faEvernote, faFacebook, faGetPocket, faHackerNews, faLine, faLinkedin, faPinterest, faReddit, faSkype, faTelegram, faTumblr, faViber, faVk, faWhatsapp, faXing, faXTwitter } from "@fortawesome/free-brands-svg-icons"
